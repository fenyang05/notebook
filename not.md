...
- 定义及实例化 01.py
        ...
        定义：         class Student():
           - 定义属性     name = "yueyue" 
           - 定义方法     def Dohomework(self): 
                             print("I am do my homework")
        实例化：       jam = student（）
           - 引用属性     jam.name
           - 调用方法     jam.Dohomework()
        对象成员检查：
...
- 构造函数
# 3.anaconda基本使用
- anaconda是一个虚拟环境管理器，还是安装包管理器
- conda list       显示anaconda的安装包列表
- conda env list   显示anaconda的虚拟环境列表
- conda create -n XXX python=3.7 创建一个python3.7虚拟环境，名称为XXX
# 4. 类和对象的成员分析
